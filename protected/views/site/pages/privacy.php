<?php $this->pageTitle=Yii::app()->name . ' - Privacy'; ?>

<h2>1. PRIVACY</h2>
We are committed to protecting Your personal information. We have created this Privacy Policy to let You know what information We collect when You use Our Services, why We collect this information and how We use the collected information.<br>
Please note that this Privacy Policy will be agreed between You and the Group being Oddsleaders party digital entertainment plc together with its Group companies as defined in the Terms and Conditions of Use ('Oddsleaders.party','We', 'Us' or 'Our', as appropriate).<br>
...
You may 'opt out' of receiving any promotional communications either by choosing to opt out where such option is made available on Our sites or the Services or in an email You receive from Us, or at any time by sending an email.

<h2>7. COOKIES</h2>

<h2>7.1. Information placed on your device</h2>
...
<h2>7.3 When do we use cookies?</h2>

We use cookies for store information about your betted matches, favourited leagus and some user information.

<h2>7.3.1 During the registration process</h2>
...
<h2>7.3.2 On Our website</h2>

For visitors to Our website, We use cookies to collect information. Our servers use two different types of cookies:<br>
...
'Analytical' cookies allow us to recognise and count the number of visitors and to see how visitors move around the site when they are using it. This helps Us to improve the way our sites works, for example, by ensuring You can what You are looking for easily.<br>

<h2>7.4. Cookies allow Us to:</h2>

Better understand Your preferences and offer You more relevant promotional offers.<br>
Distinguish You from other users of our sites, which help Us to provide You with a good experience when You browse our sites and also allows Us to improve our sites<br>
Identify Your preferences when customizing content or functionality for You. <br>
Confirm You are a registered user and save Your log-in details when accessing certain Services on Our website.<br>
Show you advertisements which are relevant to your interests based on your use of Our sites<br>
Collect statistics on the use of Our Services.<br>
We may also use cookies and web beacons to ensure that Our mailing tools are working properly.

<h2>7.5. How can I refuse or opt out of cookies?</h2>
...
<h2>8. CONSENT TO USE OF ELECTRONIC SERVICE PROVIDERS</h2>
...
<h2>9. CONSENT TO SECURITY REVIEW</h2>
...
We understand the importance of information security and the techniques needed to secure information. We store all of the Personal Information We receive directly from You in a password-
protected database residing within Our secure network behind active state-of-the-art firewall software. <br>
Our Services support SSL Version 3 with 124-bit encryption. We take steps to ensure Our subsidiaries, agents, affiliates and suppliers also employ adequate levels of security.

<h2>12. PROTECTION OF CHILDREN</h2>
...
<h2>14. THIRD-PARTY PRACTICES</h2>
...
<h2>15. LEGAL DISCLAIMER</h2>

The Services operate 'AS-IS' and 'AS-AVAILABLE,' without liability of any kind. We are not responsible for events beyond Our direct control. Because of the complex and constantly changing nature of Our technology and business, We cannot guarantee nor do We represent that there will be error-
free performance regarding the privacy of Your Personal Information, and We will not be liable for any indirect, incidental, consequential or punitive damages relating to the use or release of Personal Information.

<h2>16. MERGERS AND OTHER EVENTS REQUIRING TRANSFER</h2>
...
<h2>17. CONSENT TO PRIVACY POLICY</h2>
